...
function cards(team) {
  ...
  <div class="card-body">
    <h5 class="text-danger card-title">Managere</h5>
    <p class="card-text">${team[i].getName()}</p>
    <p class="card-text">${team[i].getRole()}</p>
    <a href="mailto:${team[i].getEmail()}" class="card-link">${team[
        i
      ].getEmail()}</a>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="mailto:${team[i].getEamil()}" class="card-link">${
        team[i].getEamil
      }</a>      </div>
        <a href="https://www.github.com/${team[
          i
        ].getGitHub()}" class="card-link">${team[i].getGitHub()}</a>      </div>
    </div>
  </div>`;
...
<body>
<header>
<h1 class= 'text-success display-4 font-weight-bold'> Team Roster </h1>
</header>
<div class="container">
${createHtml(answers)}
</body>
